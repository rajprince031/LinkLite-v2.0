...
export default function ContactMe({openMessage}) {
    return (
            <div class="profile-card">
                ...
                <div class="profile-info">
                    <p class="profile-name">Prince Raj</p>
                    <div class="profile-title">@rajprince031</div>
                    <div class="profile-bio">
                        Full-stack developer | Java Spring Boot & MERN<br/>
Engineering grad passionate about building fast, functional web apps.
                    </div>
                </div>
                <div class="social-links">
                    <a 
                    class="social-btn github"
                    href="https://github.com/rajprince031"
                    target="_blank"
                    >
                    ...
                    href="https://www.linkedin.com/in/rajprince031/"
                    target="_blank"
                    >
                        <svg viewBox="0 0 24 24">
                            <path
                    ...
                    href="https://www.instagram.com/rajprince031"
                    target="_blank"
                    >
                        <svg viewBox="0 0 24 24">
                            <path
                ...
                <button className="cta-button" onClick={openMessage}>Send Message</button>
            </div>
